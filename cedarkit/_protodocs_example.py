...
This module is safe to delete once CedarKit has real documented
...
def protodocs_example_plot(n: int = 50) -> "tuple[np.ndarray, np.ndarray]":
    ...
    import matplotlib.pyplot as plt
    import numpy as np
    from cedarkit._protodocs_example import protodocs_example_plot

    x, y = protodocs_example_plot()
    plt.savefig('docs/reference/figures/protodocs_example_plot_example.png', dpi=150, bbox_inches='tight')
    ```
    """
