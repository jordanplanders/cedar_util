...
def get_parser():
    ...
    parser.add_argument('-o', '--override', dest='override', action='store_true', help="If True, run even if output file exist")
    parser.add_argument('-w', '--write', type=str, help="If append, add to existing, if replace, overwrite existing output file")
    ...
    parser.add_argument( '--datetime_flag', type=str, help="Specify datetime cutoff (e.g. '2023-10-01 12:00:00')")
